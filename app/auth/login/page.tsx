...
export default function LoginPage() {
  ...
  return (
    <div className="font-display bg-background-light dark:bg-[#0f2320] min-h-screen flex items-center justify-center p-4 antialiased text-nordic dark:text-gray-100 relative overflow-hidden">
      {/* Background blobs */}
        ...
        <div className="bg-white dark:bg-[#152e2a] rounded-2xl shadow-soft p-8 sm:p-10 border border-white/50 dark:border-[#006655]/20 backdrop-blur-sm">
          <div className="space-y-4">
            <button
              ...
              className="group w-full flex items-center justify-center gap-3 bg-white dark:bg-[#1a3833] border border-gray-100 dark:border-[#006655]/30 rounded-lg p-3.5 text-[#19322F] dark:text-white font-medium transition-all duration-300 hover:shadow-soft-hover hover:-translate-y-0.5 relative overflow-hidden cursor-pointer"
            >
            ...
            >
              <div className="absolute inset-0 bg-[#D9ECC8]/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out"></div>
              <svg
                className="w-5 h-5 relative z-10 fill-current text-[#19322F] dark:text-white"
                viewBox="0 0 24 24"
